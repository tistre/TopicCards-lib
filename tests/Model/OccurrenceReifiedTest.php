...
class OccurrenceReifiedTest extends TestCase
{
    ...
    public function testNewReifierTopic()
    {
        ...
        $this->assertEquals(TopicInterface::REIFIES_OCCURRENCE, $reifier_topic->getReifiesWhat(), 'Reifier "what" is not "occurrence"');
        ...
        $this->assertEquals(TopicInterface::REIFIES_NONE, $reifier_topic->getReifiesWhat(), 'Reifier "what" is not "none"');
